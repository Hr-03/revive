...
import "../../../Styles/Menu/Clinic Settings/Treatments/WeightLoss.css";
...
function WeightLoss(){
  ...
  const [editWeightLoss, setEditWeightLoss] = useState({
    TreatmentID:"",
    Treatment:"",
    CreatedBy:"1",
    IPAddress:"1.1.1.1"
  ...
  const handleEditChange=(e)=>{
    const newdata={...editWeightLoss};
    newdata[e.target.name]=e.target.value;
    setEditWeightLoss(newdata);
    console.log(newdata);
}
...
const getWlUrl=`https://reviveapplication.com/ReviveAPI/Revive.svc/GetWeightLossTreatment`;
  ...
  const handleChange=(e)=>{
    ...
    return(
        <>
        <Sidebar>
        <Card className="m-1 mt-3 wl-crd p-3">
        <Row>
            <Col>
            <p className="wl-t">Weight Loss Treatment</p>
            <hr />
...
<Modal show={show} onHide={handleMClose} centered>
        ...
        <Form.Control type="text" name="Treatment" value={wl.Treatment} onChange={handleChange} placeholder="Enter treatment name" />
      </Form.Group>
              </Col>
            </Row>
          </Form>
        ...
        <Modal.Body>
          <Form>
            <Row>
              ...
              <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
        <Form.Label className="modL">Treatment Name</Form.Label>
        <Form.Control type="text" name="Treatment" value={editWeightLoss.Treatment} onChange={handleEditChange} placeholder="Enter treatment name" />
      </Form.Group>
              </Col>
            </Row>
          </Form>
        ...
        <Modal.Footer>
          ...
          <Button variant="" onClick={()=>{
            ...
            fetch(addwlUrl,{
              ...
              body: JSON.stringify(editWeightLoss)
            })
            .then((res)=>res.json())
            .then((wlRes)=>{
              console.log(wlRes);
