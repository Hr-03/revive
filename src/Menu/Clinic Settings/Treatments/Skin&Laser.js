...
import "../../../Styles/Menu/Clinic Settings/Treatments/Skin&Laser.css";
...
function SkinAndLaser(){
  ...
  const [editSkinandLaser, setEditSkinandLaser] = useState({
    TreatmentID:"",
    Treatment:"",
    CreatedBy:"1",
    IPAddress:"1.1.1.1"
  ...
  const handleEditChange=(e)=>{
    const newdata={...editSkinandLaser};
    newdata[e.target.name]=e.target.value;
    setEditSkinandLaser(newdata);
    console.log(newdata);
}
...
.then((slRes)=>{
  ...
  useEffect(() => {
    ...
    return(
        ...
        <Row>
            <Col>
            <p className="sl-t">Skin and Laser Treatment</p>
            <hr />
...
<Modal show={show} onHide={handleMClose} centered>
        ...
        <Form.Control type="text" name="Treatment" value={sl.Treatment} onChange={handleChange} placeholder="Enter treatment name" />
      </Form.Group>
              </Col>
            </Row>
          </Form>
...
<Modal show={show1} onHide={handleMClose1} centered>
        ...
        <Modal.Body>
          <Form>
            <Row>
              ...
              <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
        <Form.Label className="modL">Treatment Name</Form.Label>
        <Form.Control type="text" name="Treatment" value={editSkinandLaser.Treatment} onChange={handleEditChange} placeholder="" />
      </Form.Group>
              </Col>
            </Row>
          </Form>
        ...
        <Modal.Footer>
          ...
          body: JSON.stringify(editSkinandLaser)
            })
            .then((res)=>res.json())
            .then((result)=>{
              console.log(result);
