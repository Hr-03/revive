...
import "../../Styles/Menu/User Settings/EmployeeRegistration.css";
  ...
  const handleReportClick = () => {
    ...
    return(
      ...
      <Card className="m-1 mt-3 emp-crd p-3">
        <Row>
            <Col>
            <p className="ap-t">Employee Registration</p>
            <hr />
                    ...
                    <Box sx={{ display: "flex", gap: "1rem" }}>
                      <Tooltip arrow placement="left" title="Edit">
                        ...
                        onClick={() =>{
                          ...
                          sessionStorage.setItem("empUserID",userID)
                          navigate(`/edit-emp/${userID}`)
                        }}
