...
function EditEmployee() {
    ...
    let empID=sessionStorage.getItem("empUserID");
    ...
    const handleSubmit=(e)=>{
      ...
      }else if(editEmp.FirstName.match(namePattern) || editEmp.LastName.match(namePattern)){
        Swal.fire({
          icon:"warning",
          titleText:"Name should contain alphabets only!"
        })
      }
      else if(editEmp.MobileNo.length>15){
        Swal.fire({
          icon:"warning",
          titleText:"Mobile no. cannot be more than 15 digits!"
        })
      }
      else if(editEmp.MobileNo.length<7){
        Swal.fire({
          icon:"warning",
          titleText:"Mobile no. cannot be less than 7 digits!"
        })
      }
      else if(editEmp.MobileNo.match(mobilePattern)){
        Swal.fire({
          icon:"warning",
          titleText:"Mobile no. should contain only digits!"
        })
      }
      else if(editEmp.Address1.match(addressPattern) || editEmp.Address2.match(addressPattern)){
        Swal.fire({
          icon:"warning",
...
//   const [empDetails, setEmpDetails] = useState([]);
    ...
    .then((result)=>{
        ...
        setEditEmp((pre)=>{
            return{
                ...
                BirthDate:result.Data[0]?.BirthDate.split(" ")[0],
  ...
  return (
    ...
    <Card className="m-1 mt-3 emp-crd p-3">
        <Row>
            <Col>
            <p className="emp-t">Edit Employee</p>
            <hr />
        ...
        <Form.Select aria-label="Default select example" value={editEmp?.ClinicID} name="ClinicID" onChange={handleChange}>
      <option></option>
      {branch.map((b) => {
                                return (
                                  <>
        ...
        <Form.Select aria-label="Default select example" value={editEmp?.Designation} name="Designation" onChange={handleChange}>
      <option></option>
     {
      designation.map((d,i)=>{
        return(
        ...
        <Form.Control type="email" placeholder="" value={editEmp?.Email} name="Email" onChange={handleChange}/>
        ...
        <Form.Control type="text" placeholder="" value={editEmp?.FirstName} name="FirstName" onChange={handleChange}/>
        ...
        <Form.Control type="text" placeholder="" value={editEmp?.LastName} name="LastName" onChange={handleChange}/>
        ...
        <Form.Control type="tel" placeholder="" value={editEmp?.MobileNo} name="MobileNo" onChange={handleChange}/>
        ...
        <Form.Select aria-label="Default select example" value={editEmp?.Gender} name="Gender" onChange={handleChange}>
      <option></option>
      ...
      <option value="Female">Female</option>
        ...
        <Form.Select aria-label="Default select example" value={editEmp?.Nationality} name="Nationality" onChange={handleChange}>
      <option></option>
      <option value="Indian">Indian</option>
        ...
        <Form.Control as="textarea" rows={2} placeholder="" name="Address1" value={editEmp?.Address1} onChange={handleChange}/>
        ...
        <Form.Control as="textarea" rows={2} placeholder="" value={editEmp?.Address2} name="Address2" onChange={handleChange}/>
      ...
      {cities.currentCities &&
        ...
        <Form.Control type="number" placeholder="" value={editEmp?.Pincode} name="Pincode" onChange={handleChange}/>
        ...
        <Form.Control type="text" placeholder="" value={editEmp?.username} name="username" onChange={handleChange}/>
        ...
        <Form.Control type="password" placeholder="" value={editEmp?.Passwords} name="Passwords" onChange={handleChange}/>
