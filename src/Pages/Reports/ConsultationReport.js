...
import "../../Styles/Reports/ConsultationReport.css";
...
function ConsultationReport() {
  ...
  const getCnsltUrl=`https://reviveapplication.com/ReviveAPI/Revive.svc/GetConsultationReport/0/0/${User}`;
useEffect(()=>{
  fetch(getCnsltUrl)
  .then((res)=>res.json())
  .then((geteRes)=>{
...
<div className='pt-3'>
      ...
      <Button variant='' className='mx-3 rptBtn mt-4' onClick={(e)=>{
        ...
        const datefiltered=`https://reviveapplication.com/ReviveAPI/Revive.svc/GetConsultationReport/${datedata?.startDate}/${datedata?.endDate}/${User}`
        fetch(datefiltered)
        .then((res)=>res.json())
        .then((geteRes)=>{
          console.log(geteRes.Data);
...
<div className='d-flex justify-content-between m-2'>
  <CSVLink data={consultations} style={{textDecoration:"none",color:"white",backgroundColor:"green",borderRadius:"5px"}} className='p-2'><LiaDownloadSolid fontSize={25}/>Excel</CSVLink>
            ...
            <MaterialReactTable
                  ...
                  renderRowActions={({cell, row, table }) => (
                    <Box sx={{ display: "flex", gap: "1rem" }}>
                      <Tooltip arrow placement="left" title="History">
                        <IconButton 
