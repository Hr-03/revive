...
<Row>
    ...
    <Row className='mt-4'>
        ...
        <Form.Control type="date" placeholder="" name='Date' onChange={handleChangeConsultations}/>
      </Form.Group>
        </Col>
        <Col md={4}>
        <Form.Group className="mb-3" controlId="formGroupEmail">
        <Form.Label>Treatments</Form.Label>
        <Form.Select aria-label="Default select example" name='TreatmentID' onChange={handleChangeConsultations}>
      <option></option>
     {
      treatments?.map((t,i)=>{
        return(
    ...
    <Row className='mt-4'>
        ...
        <Form.Control as="textarea" rows={3} name='TreatmentDetails' onChange={handleChangeConsultations}/>
      </Form.Group>
        </Col>
    </Row>
    ...
    <Row className='mt-4'>
      <Col>
      <Form.Check type='checkbox' id='wlTT' label="Weight Loss Treatment Taken?" onChange={handleChange}/>
...
<Button variant='' className='mt-4 px-4 m-auto' style={{backgroundColor:"#9B7BB7",color:"white",textTransform:"capitalize"}} onClick={handleImages}>Upload Image(s)</Button>
     ...
     <Row className='mt-4'>
      ...
      <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
        ...
        <Form.Control as="textarea" rows={1} name='Remarks'  onChange={handleChangeConsultations}/>
      </Form.Group>
      </Col>
      <Col md={3}>
      <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
        <Form.Label>Status</Form.Label>
        <Form.Select aria-label="Default select example" name='Status' onChange={handleChangeConsultations}>
      <option></option>
...
<Modal
      ...
      >
       ...
       <Modal.Body>
        ...
        <Form.Control type="text" placeholder="" name='Neck' onChange={handleChangeMeasurement} className='igc'/>
        ...
        <Form.Label className='m-0'>Left Arm</Form.Label>
          <InputGroup className="mb-3" controlId="exampleForm.ControlInput1">
        <Form.Control type="text" placeholder="" name='LeftArm' onChange={handleChangeMeasurement} className='igc'/>
        <InputGroup.Text id="basic-addon2" className='igt'>Inch</InputGroup.Text>
        ...
        <Form.Label className='m-0'>Right Arm</Form.Label>
          <InputGroup className="mb-3" controlId="exampleForm.ControlInput1">
        <Form.Control type="text" placeholder="" name='RightArm' onChange={handleChangeMeasurement} className='igc'/>
        <InputGroup.Text id="basic-addon2" className='igt'>Inch</InputGroup.Text>
        ...
        <Form.Label className='m-0'>Chest</Form.Label>
          <InputGroup className="mb-3" controlId="exampleForm.ControlInput1">
        <Form.Control type="text" placeholder="" name='Chest' onChange={handleChangeMeasurement} className='igc'/>
        <InputGroup.Text id="basic-addon2" className='igt'>Inch</InputGroup.Text>
        ...
        <Form.Label className='m-0'>Upper Abdomen</Form.Label>
          <InputGroup className="mb-3" controlId="exampleForm.ControlInput1">
        <Form.Control type="text" placeholder="" name='UpperAbdomen' onChange={handleChangeMeasurement} className='igc'/>
        <InputGroup.Text id="basic-addon2" className='igt'>Inch</InputGroup.Text>
        ...
        <Form.Label className='m-0'>Mid Abdomen</Form.Label>
          <InputGroup className="mb-3" controlId="exampleForm.ControlInput1">
        <Form.Control type="text" placeholder="" name='MidAbdomen' onChange={handleChangeMeasurement} className='igc'/>
        <InputGroup.Text id="basic-addon2" className='igt'>Inch</InputGroup.Text>
        ...
        <Form.Label className='m-0'>Lower Abdomen</Form.Label>
          <InputGroup className="mb-3" controlId="exampleForm.ControlInput1">
        <Form.Control type="text" placeholder="" name='LowerAbdomen' onChange={handleChangeMeasurement} className='igc'/>
        <InputGroup.Text id="basic-addon2" className='igt'>Inch</InputGroup.Text>
        ...
        <Form.Label className='m-0'>Hips</Form.Label>
          <InputGroup className="mb-3" controlId="exampleForm.ControlInput1">
        <Form.Control type="text" placeholder="" name='Hips' onChange={handleChangeMeasurement} className='igc'/>
        <InputGroup.Text id="basic-addon2"className='igt'>Inch</InputGroup.Text>
        ...
        <Form.Label className='m-0'>Upper Left Thigh</Form.Label>
          <InputGroup className="mb-3" controlId="exampleForm.ControlInput1">
        <Form.Control type="text" placeholder="" name='UpperLeftThigh' onChange={handleChangeMeasurement} className='igc'/>
        <InputGroup.Text id="basic-addon2" className='igt'>Inch</InputGroup.Text>
        ...
        <Form.Label className='m-0'>Middle Left Thigh</Form.Label>
          <InputGroup className="mb-3" controlId="exampleForm.ControlInput1">
        <Form.Control type="text" placeholder="" name='MiddleLeftThigh' onChange={handleChangeMeasurement} className='igc'/>
        <InputGroup.Text id="basic-addon2" className='igt'>Inch</InputGroup.Text>
        ...
        <Form.Label className='m-0'>Lower Left Thigh</Form.Label>
          <InputGroup className="mb-3" controlId="exampleForm.ControlInput1">
        <Form.Control type="text" placeholder="" name='LowerLeftThigh' onChange={handleChangeMeasurement} className='igc'/>
        <InputGroup.Text id="basic-addon2" className='igt'>Inch</InputGroup.Text>
        ...
        <Form.Label className='m-0'>Upper Right Thigh</Form.Label>
          <InputGroup className="mb-3" controlId="exampleForm.ControlInput1">
        <Form.Control type="text" placeholder="" name='UpperRightThigh' onChange={handleChangeMeasurement} className='igc'/>
        <InputGroup.Text id="basic-addon2" className='igt'>Inch</InputGroup.Text>
        ...
        <Form.Label className='m-0'>Middle Right Thigh</Form.Label>
          <InputGroup className="mb-3" controlId="exampleForm.ControlInput1">
        <Form.Control type="text" placeholder="" name='MiddleRightThigh' onChange={handleChangeMeasurement} className='igc'/>
        <InputGroup.Text id="basic-addon2" className='igt'>Inch</InputGroup.Text>
        ...
        <Form.Label className='m-0'>Lower Right Thigh</Form.Label>
          <InputGroup className="mb-3" controlId="exampleForm.ControlInput1">
        <Form.Control type="text" placeholder="" name='LowerRightThigh' onChange={handleChangeMeasurement} className='igc'/>
        <InputGroup.Text id="basic-addon2" className='igt'>Inch</InputGroup.Text>
        ...
        <Form.Label className='m-0'>Right Calf</Form.Label>
          <InputGroup className="mb-3" controlId="exampleForm.ControlInput1">
        <Form.Control type="text" placeholder="" name='RightCalf' onChange={handleChangeMeasurement} className='igc'/>
        <InputGroup.Text id="basic-addon2" className='igt'>Inch</InputGroup.Text>
        ...
        <Form.Label className='m-0'>Left Calf</Form.Label>
          <InputGroup className="mb-3" controlId="exampleForm.ControlInput1">
        <Form.Control type="text" placeholder="" name='LeftCalf' onChange={handleChangeMeasurement} className='igc'/>
        <InputGroup.Text id="basic-addon2" className='igt'>Inch</InputGroup.Text>
...
<Row className='mt-4'>
  ...
  <Button variant='' className='clt-submit' type='submit' onClick={(e)=>{
    ...
    let n={
      ...consultation,
      Images:consultation?.Images?.toString()
    }
