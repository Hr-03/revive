...
import "../Styles/ViewConsultationHistory.css";
...
function ViewConsultationHistory() {
    ...
    let consultID=sessionStorage.getItem("consltID");
   ...
   <>
    ...
    <Card className="m-1 mt-3 emp-crd p-3">
        <Row>
            ...
            <Row>
              <Col>
            <p className="ap-t">View Consultation History</p>
            ...
            <Row>
                <Col>
           <p><u>Date: </u><span className='mx-2'>{consultationDetails?.Date?.split(" ")[0]}</span></p>
                <p><u>Treatments:</u><span className='mx-2'>{consultationDetails?.Treatment}</span></p>
                <p><u>Treatment Details:</u><span className='mx-2'>{consultationDetails?.TreatmentDetails}</span></p>
                <p><u>Measurement Record</u></p>


                <Table responsive className='msrmnt-tbl'>
  <tbody>
    <tr>
    ...
    <tr>
      ...
      <p><u>Image:</u></p>
{
    consultationDetails?.Image?.map((images,i)=>{
        return(
            <>
            <p>
...
<p><u>Observations/Remarks:</u><span className='mx-2'>{consultationDetails?.Remarks}</span></p>

<p><u>Status:</u><span className='mx-2'>{consultationDetails?.Status}</span></p>
                </Col>
            </Row>
